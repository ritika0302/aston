<div class="stamp-duty-calculator-scotland">
    ...
    <input type="text" name="purchase_price" id="purchase_price" value="<?php echo $atts['price']; ?>" placeholder="e.g. 500,000">
    ...
    <div class='stamp_duty_error'>Please enter a price above</div>
